...
@EmbeddedMongoTest
public class ExperimentComputationServiceTestBase {
    ...
    protected static final ExperimentComputation TEST_COMPUTATION_1B =
            new ExperimentComputation(ObjectId.get(), CONFIGURATION_ID_1, Instant.ofEpochSecond(10));
    protected static final ExperimentComputation TEST_COMPUTATION_2 =
            new ExperimentComputation(ObjectId.get(), CONFIGURATION_ID_2, Instant.ofEpochSecond(100));
